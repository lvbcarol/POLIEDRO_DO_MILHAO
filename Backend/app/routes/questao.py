...
def adicionar_questao():
    ...
    if not all([enunciado, alternativaA, alternativaB, alternativaC, alternativaD, resposta_correta]):
...
@questao_bp.route("/check_answer", methods=["POST"])
@jwt_required() # Geralmente verificar resposta é parte de um fluxo autenticado
